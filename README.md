...
1. Preguntas de autoevaluación:
   ...
   3. ¿Que tipo de dato JavaScript devuelve la respuesta de la API? Json, en este caso objeto
   4. ¿Cuál es la propiedad de este objeto que contiene el texto del chiste? value
